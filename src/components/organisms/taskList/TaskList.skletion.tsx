...
const TaskListSkletion = () => {
  const taskSkletions: string[] = new Array(3).fill('1');

  return (
    <div className="mb-12">
      <div className="mt-4 flex h-full flex-col justify-center gap-y-4">
        {taskSkletions.map((_, index) => (
          <Fragment key={`TaskSkletion_${index}`}>
...
export default TaskListSkletion;
